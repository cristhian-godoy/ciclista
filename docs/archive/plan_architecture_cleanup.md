...
- [x] **Task 1: Create `core/config/types.ts`**
...
- [x] **Task 2: Centralize Configuration Defaults**
...
- [x] **Task 3: Refactor Storage Adapters**
...
- [x] **Task 4: Establish Barrel Exports**
...
- [x] **Task 1: Define `core/rules/types.ts`**
...
- [x] **Task 2: Create `osm-mapper.ts`**
  - _Details_: Move the contents of `src/core/router/rules.ts` here (excluding defaults).
- [x] **Task 3: Create `impact-resolver.ts` & `bike-impacts.ts`**
...
- [x] **Task 4: Untangle Circular Domain Logic in `geometry.ts`**
...
- [x] **Task 5: Establish Barrel Exports**
...
- [x] **Task 1: Clean `core/router/types.ts` & Document Dependencies**
...
- [x] **Task 2: Fix `haversineDistance` Module Placement**
...
- [x] **Task 3: Decouple Statistics from Dijkstra**
...
- [x] **Task 4: Establish Edge Metrics Module**
...
- [x] **Task 1: Create `core/router/strategies.ts`**
...
- [x] **Task 2: Standardize Strategy Invocation**
...
- [x] **Task 1: Strip `alternativeEvaluations` from `RouteResult`**
...
- [x] **Task 1: Create `useIntersectionBranches` and Hoist State**
...
- [x] **Task 2: Update `InspectorLayer.tsx` and Intersection Node Logic**
...
- [x] **Task 3: Update `InspectorPanel.tsx`, `StreetGraphLayer.tsx`, & `geojson.ts`**
...
- [x] **Task 4: Update Mapper & Test Suites**
