...
Thank you for that detailed breakdown. You are absolutely right—I missed the nuance of German cycling infrastructure. The difference between an _indirektes Linksabbiegen_ (waiting at two pedestrian/bike lights) versus a direct left turn (mingling with cars but skipping a light phase), or a right turn with a _Grünpfeil_ versus a hard stop, makes a massive difference in route calculation.
...
**Example UI Concept:**
You click the intersection of _Leopoldstraße_ and _Franz-Joseph-Straße_.
...
- **Free Right Turn:** (Protected / _Baulich getrennt_ / _Grünpfeil_) -> **0s wait time**.
