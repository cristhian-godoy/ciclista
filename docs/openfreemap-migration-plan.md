...
- [ ] **Bite 1.1: Restore and Update CSP**
  - **File:** `index.html`
...
- [ ] **Bite 2.1: Replace MapLibre Style Object**
...
- [ ] **Bite 3.2: Reactive Style Updates**
  - **File:** `src/components/map/useMapInstance.ts`
